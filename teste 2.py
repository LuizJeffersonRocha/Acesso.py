...
tree.column('Descrição', width=400, anchor='center', stretch=tk.YES)
tree.column('Local', width=300, anchor='center', stretch=tk.YES)
tree.column('Horário de Funcionamento', width=200, anchor='center', stretch=tk.YES)
tree.column('Contatos', width=200, anchor='center', stretch=tk.YES)
