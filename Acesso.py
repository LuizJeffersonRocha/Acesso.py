...
root.geometry("1200x800")  # Ajuste no tamanho da janela
root.configure(bg='#e0f7fa')  # Cor de fundo

# Estilo para a Treeview
style = ttk.Style()
style.configure('Treeview', rowheight=40, font=('Helvetica', 12))  # Aumentando a altura das linhas e o tamanho da fonte
style.configure('Treeview.Heading', font=('Helvetica', 14, 'bold'))  # Estilo do cabeçalho
...
frame_tabela = tk.Frame(root, bg='#e0f7fa')  # Cor de fundo
...
# Ajuste das larguras das colunas para exibir todo o conteúdo
tree.column('ID', width=50, anchor='center')
tree.column('Nome', width=250, anchor='center')
tree.column('Descrição', width=350, anchor='center')
tree.column('Local', width=350, anchor='center')
tree.column('Horário de Funcionamento', width=200, anchor='center')
tree.column('Contatos', width=200, anchor='center')
...
frame_botoes = tk.Frame(root, bg='#e0f7fa')  # Cor de fundo
